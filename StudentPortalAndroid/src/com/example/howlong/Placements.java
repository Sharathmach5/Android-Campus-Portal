...
String url ="http://miniprojectcvr.atwebpages.com/getjob.php";
ProgressDialog pd;
		...
		lv = (ListView) findViewById(R.id.listView1);
			...
			public class LoadUrl extends AsyncTask<String, String, String>
			{
				...
				protected void onPreExecute() {
					...
					super.onPreExecute();
					pd=new ProgressDialog(Placements.this);
					pd.setTitle("Getting Placement Details..");
					pd.setMax(100);
				...
				protected String doInBackground(String... params) {
					...
					try {
						...
						for(int i=0;i<arr.length();i++)					
						{
							...
							map.put("Placements", js.getString ("value"));
				...
				protected void onPostExecute(String result) {
					...
					if(pd!=null && pd.isShowing())
						pd.dismiss();
					adapter=new SimpleAdapter(Placements.this, list, R.layout.customlist, new String[]{"Placements"}, new int[]{R.id.textView1});
